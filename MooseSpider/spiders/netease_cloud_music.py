...
class NeteaseCloudMusicSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for item in html_list:
          ...
          hot_num = Selector(text=item).xpath("//tr/td[1]/div[@class='hd']/span/text()").extract_first()
          hot_rk = Selector(text=item).xpath("//tr/td[1]/div[@class='hd']/div/span[@class='ico u-icn u-icn-73 s-fc9']/text()").extract_first()

          song_pic = Selector(text=item).xpath("//tr/td[2]/div[@class='f-cb']/div[@class='tt']/a/img/@src").extract_first()
          song_name = Selector(text=item).xpath("//tr/td[2]/div[@class='f-cb']/div[@class='tt']/div[@class='ttc']/span/a/b/@title").extract_first()
          
          song_time = Selector(text=item).xpath("//tr/td[3]/span/text()").extract_first()

          singer_name = Selector(text=item).xpath("//tr/td[4]/div[@class='text']/@title").extract_first()
